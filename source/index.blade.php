...
<section class="container max-w-6xl mx-auto px-6 py-10 md:py-12">
    <div class="flex flex-col-reverse mb-10 lg:flex-row lg:mb-24">
        <div class="mt-8">
            ...
            <p class="text-lg">A set of components to utilise in your Laravel Blade views using TALL stack.</p>
            ...
            <div class="flex my-10">
                ...
                <a href="https://github.com/datalogix/tall-kit" target="_blank" title="Source Code" class="bg-gray-400 hover:bg-gray-600 text-blue-900 font-normal hover:text-white rounded py-2 px-6">Source Code</a>
            </div>
        </div>
